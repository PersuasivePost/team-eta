    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-4 text-balance">
            THE CHALLENGE: <span className="text-teal-600">SHELL ECO-MARATHON</span>
          </h1>
          <p className="text-2xl md:text-3xl text-teal-600 font-semibold mb-8">THIRST FOR INNOVATIONS</p>
          <div className="h-1 w-32 bg-gradient-to-r from-teal-600 to-transparent mx-auto"></div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex items-center justify-center lg:justify-end">
              <div className="w-full max-w-md bg-white shadow-md border border-gray-200 rounded-lg p-8 hover:border-teal-600/50 transition-all duration-300">
                <h3 className="text-3xl font-bold text-gray-900 mb-6">PROTOTYPE</h3>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-teal-600 text-sm font-semibold uppercase tracking-wider">Maximum Innovation</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="h-1 w-24 bg-gradient-to-r from-teal-600 to-transparent mx-auto"></div>
          </div>
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {achievements.map((achievement, index) => (
              <div key={index} className="group">
                <div className="bg-white shadow-md border border-gray-200 hover:border-teal-600/50 rounded-lg p-6 transition-all duration-300 hover:bg-gray-50">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-3">
                    <div className="flex items-center gap-3">
                      <span className="text-teal-600 font-bold text-lg">{achievement.year}</span>
                      <div className="hidden md:block w-1 h-1 bg-teal-600/50 rounded-full"></div>
                      <h3 className="text-xl font-bold text-gray-900">{achievement.title}</h3>
                    </div>
                    <span className="text-sm text-teal-600/70 uppercase tracking-wider">{achievement.event}</span>
                  </div>
